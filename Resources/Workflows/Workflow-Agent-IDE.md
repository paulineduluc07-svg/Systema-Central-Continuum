...
- Toute mission ou l'IDE est l'environnement principal de lecture, modification et validation.\n- Toute tache de code, structure ou debug pilotee depuis l'IDE.

## 3) Quand NE PAS utiliser ce workflow
- Tache purement terminal, no-code ou recherche sans IDE central.\n- Tache purement documentaire tres legere.\n- Action bloquee par regles de securite sans autorisation explicite.
