...
- Toute mission d'analyse, d'audit, de comparaison, d'exploration ou de diagnostic.\n- Toute tache ou la qualite du raisonnement et du constat est prioritaire sur l'execution.

## 3) Quand NE PAS utiliser ce workflow
- Tache de mise en oeuvre immediate sans phase d'analyse reelle.\n- Tache ou la recherche n'apporte pas de valeur concrete.\n- Action bloquee par regles de securite sans autorisation explicite.
