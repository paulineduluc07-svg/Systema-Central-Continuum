...
- Correctif UX : remplacement des `contentEditable` par de vrais inputs transparents pour rendre l'edition fiable; validation `pnpm check`, `pnpm test`, `pnpm build` OK.
