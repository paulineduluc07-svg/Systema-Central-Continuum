...
- Toute mission centree sur interface, design system, direction visuelle ou experience utilisateur.\n- Toute tache ou le livrable principal est graphique ou de presentation.

## 3) Quand NE PAS utiliser ce workflow
- Tache purement backend, doc ou gouvernance.\n- Tache ou aucun livrable visuel n'est attendu.\n- Action bloquee par regles de securite sans autorisation explicite.
