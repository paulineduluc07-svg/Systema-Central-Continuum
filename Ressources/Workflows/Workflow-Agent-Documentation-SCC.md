...
- Toute mission centree sur la documentation du SCC, des projets ou des regles de travail.\n- Toute tache ou la clarte documentaire est le livrable principal.

## 3) Quand NE PAS utiliser ce workflow
- Tache de code ou de design dont la doc n'est qu'un effet secondaire.\n- Nettoyage destructif non valide.\n- Action bloquee par regles de securite sans autorisation explicite.
